...
class App extends Component {
    ...
    state = {
        ...
        totalPages: null //  the total number of pages for all the country records. Initialized to null.
    };
    ...
    onPageChanged = data => { //  will be called each time we navigate to a new page from the pagination control
                ...
                <div className="row d-flex flex-row py-5">
                  ...
                  Page <span className="font-weight-bold">{currentPage}</span> / <span
                        ...
                        <div className="d-flex flex-row py-4 align-items-center">
                            <Pagination totalRecords={totalCountries} pageLimit={18} pageNeighbours={1}
